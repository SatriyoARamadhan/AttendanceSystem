...
<head>
  ...
  <link rel="stylesheet" href="//cdn.datatables.net/1.10.7/css/jquery.dataTables.min.css">
        ...
        <script src="http://cdn.datatables.net/1.10.7/js/jquery.dataTables.min.js" defer></script>
        ...
        <script type="text/javascript" src="https://cdn.datatables.net/v/dt/jszip-2.5.0/dt-1.10.20/b-1.6.1/b-colvis-1.6.1/b-flash-1.6.1/b-html5-1.6.1/datatables.min.js" defer></script>
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href=" {{url('/staff/home')}} " class="navbar-brand"> 
                 <b>Absensi</b>
                </a>
            
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>{{ Auth::user() ? Auth::user()->name : '' }}</span></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a href="{{url('/staff/home')}}"><span class="fa-home fa"></span> Dashboard 
                        <span></span>
                      </a>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                       <span class="fa fa-check-square-o"></span>Siswa
                       <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{ route('staff.student.index') }}">Daftar Siswa</a></li>
                        <li><a href="{{ route('staff.student.create') }}">Tambah Siswa</a></li>
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                       <span class="fa fa-check-square-o"></span>Rombel
                       <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{ route('staff.rombel.index') }}">Daftar Rombel</a></li>
                        <li><a href="{{ route('staff.rombel.create') }}">Tambah Rombel</a></li>
                      </ul>
                    </li>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                       <span class="fa fa-check-square-o"></span>Rayon
                       <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{ route('staff.rayon.index') }}">Daftar Rayon</a></li>
                        <li><a href="{{ route('staff.rayon.create') }}">Tambah Rayon</a></li>
                      </ul>
                    </li>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                       <span class="fa fa-check-square-o"></span>Kehadiran
                       <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{ route('staff.attendance.create') }}">Perbarui Kehadiran</a></li>
                      </ul>
                    </li>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">SMK Wikrama BOGOR</h3>
            ...
            <div id="right-menu">
              ...
              <div class="tab-content">
                ...
                <div class="col-md-12 chatbox">
                  <div class="col-md-12">
                    <a href="#" class="close-chat">X</a><h4>Satriyo A Ramadhan</h4>
                  </div>
                  <div class="chat-area">
        ...
        <div class="mimin-mobile-menu-list">
            <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa fa-pencil-square"></span>Data Rombel
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
