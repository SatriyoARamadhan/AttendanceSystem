              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a href="{{url('')}}"><span class="fa-home fa"></span> Dashboard 
                        <span></span>
                      </a>
                    </li>
                    <li class="ripple">
                    ...
                    <li class="ripple">
                      ...
                      <ul class="nav nav-list tree">
                        <li><a href="{{ route('staff.attendance.create') }}">Daftar Rayon</a></li>
                        <li><a href="{{ route('staff.attendance.create') }}">Tambah Rayon</a></li>
                      </ul>
                    </li>
                    </li>
                    <li class="ripple">
